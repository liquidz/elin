...
This project is being developed as the successor to https://github.com/liquidz/vim-iced[vim-iced] and, like vim-iced, is heavily inspired by https://github.com/clojure-emacs/cider[CIDER].
