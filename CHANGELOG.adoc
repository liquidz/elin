...
- Fix to show source file path correctly in nREPL test results
- Fixed to pass the same nrepl component instance to middleware and interceptor during evaluation
- Fix test-var-query!! to handle session ID
- Update tests to use isolated sessions by default

== [2025.12.1-alpha] - 2025-12-31

=== Added

- Add ?ConfigLinter schema to config.clj
- Add lint-config function to validate configuration files
- Add lint subcommand to validate configuration files
- Add 'lint' sub-command to elin CLI for configuration validation

== [2025.12.0-alpha] - 2025-12-31
...
== [2025.4.1-alpha] - 2025-04-11

=== Added

- Add elin.handler.test/run-all-tests handler (#45)
- Add ElinTestAll command and its mapping (#45)
...
- Fix error handling on correct-test-vars-automatically interceptor
- Fix elin.handler.test/rerun-last-tests to support project? query (#45)
